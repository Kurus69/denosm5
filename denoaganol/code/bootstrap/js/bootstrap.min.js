...
!function (a) {
    ...
    b.prototype = {
      ...
      enforceFocus: function () {
        ...
        a(document).on("focusin.modal", function (a) {
          b.$element[0] !== a.target && !b.$element.has(a.target).length &&
            b.$element.focus();
        });
      },
      escape: function () {
  ...
  !function (a) {
    ...
    a.fn.dropdown = function (b) {
      ...
      a(document).on("click.dropdown.data-api touchstart.dropdown.data-api", d)
        .on(
    ...
    b.prototype = {
        ...
        this.offsets = a([]),
          ...
          c = this.$body.find(this.selector).map(function () {
            var c = a(this),
              ...
              e = /^#\w/.test(d) && a(d);
            return e && e.length &&
                [[e.position().top + b.$scrollElement.scrollTop(), d]] || null;
          }).sort(function (a, b) {
            return a[0] - b[0];
          }).each(function () {
      ...
      activate: function (b) {
        ...
        this.activeTarget = b,
          ...
          d = this.selector + '[data-target="' + b + '"],' + this.selector +
            '[href="' + b + '"]',
  ...
  !function (a) {
    ...
    b.prototype = {
      ...
      getOptions: function (b) {
        return b = a.extend(
          {},
          a.fn[this.type].defaults,
          b,
          this.$element.data(),
        ),
          b.delay && typeof b.delay == "number" &&
      ...
      show: function () {
        ...
        if (this.hasContent() && this.enabled) {
          a = this.tip(),
            ...
            f = typeof this.options.placement == "function"
              ? this.options.placement.call(this, a[0], this.$element[0])
              : this.options.placement,
            b = /in/.test(f),
            a.detach().css({ top: 0, left: 0, display: "block" }).insertAfter(
              this.$element,
            ),
      ...
      fixTitle: function () {
        ...
        (a.attr("title") || typeof a.attr("data-original-title") != "string") &&
          a.attr("data-original-title", a.attr("title") || "").removeAttr(
            "title",
          );
      },
      hasContent: function () {
      ...
      getPosition: function (b) {
        return a.extend(
          {},
          b ? { top: 0, left: 0 } : this.$element.offset(),
          {
  ...
  !function (a) {
    ...
    b.prototype.checkPosition = function () {
      ...
      typeof e != "object" && (f = g = e),
        ...
        i = this.unpin != null && c + this.unpin <= d.top
          ? !1
  ...
  !function (a) {
    ...
    b.prototype = {
      ...
      reset: function (a) {
        ...
        return this.$element.removeClass("collapse")[b](a || "auto")[0]
          .offsetWidth,
    ...
    a.fn.collapse = function (c) {
      ...
      a(document).on(
        ...
        function (b) {
          var c = a(this),
            d,
            e = c.attr("data-target") || b.preventDefault() ||
  ...
  !function (a) {
    var b = function (b, c) {
      this.$element = a(b),
        ...
        this.$element.on("mouseenter", a.proxy(this.pause, this)).on(
          "mouseleave",
    ...
    b.prototype = {
      ...
      process: function (b) {
        ...
        return b = a.grep(b, function (a) {
          ...
          b = this.sorter(b),
          b.length ? this.render(b.slice(0, this.options.items)).show()
          : this.shown ? this.hide() : this;
      },
      matcher: function (a) {
      ...
      sorter: function (a) {
        ...
        while (e = a.shift()) {
          e.toLowerCase().indexOf(this.query.toLowerCase())
            ? ~e.indexOf(this.query) ? c.push(e) : d.push(e)
            : b.push(e);
        }
        return b.concat(c, d);
      },
      ...
      listen: function () {
        this.$element.on("blur", a.proxy(this.blur, this)).on(
          "keypress",
          a.proxy(this.keypress, this),
        ).on("keyup", a.proxy(this.keyup, this)),
          this.eventSupported("keydown") &&
          this.$element.on("keydown", a.proxy(this.keydown, this)),
          this.$menu.on("click", a.proxy(this.click, this)).on(
            "mouseenter",
            "li",
