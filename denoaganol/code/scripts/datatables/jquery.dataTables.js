  ...
  (function (factory) {
    ...
    function _fnLanguageCompat(oLanguage) {
      ...
      /* Backwards compatibility - if there is no sEmptyTable given, then use the same as
		 ...
		 */
      if (
        !oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
      ...
      if (
        !oLanguage.sLoadingRecords && oLanguage.sZeroRecords &&
    ...
    function _fnBrowserDetect(oSettings) {
      ...
      oSettings.oBrowser.bScrollbarLeft =
        $("#DT_BrowserTest", n).offset().left !== 1 ? true : false;
    ...
    function _fnGetCellData(oSettings, iRow, iCol, sSpecific) {
      ...
      if (
        (sData === oData || sData === null) && oCol.sDefaultContent !== null
      ) {
    ...
    function _fnGetObjectDataFn(mSource) {
      if (mSource === null) {
        ...
        typeof mSource === "string" && (mSource.indexOf(".") !== -1 ||
    ...
    function _fnDraw(oSettings) {
      ...
      if (oSettings.aiDisplay.length !== 0) {
        ...
        if (
          oSettings.iDraw == 1 && oSettings.sAjaxSource !== null &&
      ...
      if (oSettings.nTBody) {
        ...
        /* When doing infinite scrolling, only remove child rows when sorting, filtering or start
			 ...
			 */
        if (
          !oSettings.oScroll.bInfinite || !oSettings._bInitComplete ||
    ...
    function _fnAddOptionsHtml(oSettings) {
      ...
      oSettings.nTableWrapper = $(
        '<div id="' + oSettings.sTableId + '_wrapper" class="' +
          oSettings.oClasses.sWrapper + '" role="grid"></div>',
      )[0];
      ...
      for (var i = 0; i < aDom.length; i++) {
        ...
        if (cOption == "<") {
          ...
          cOption == "l" && oSettings.oFeatures.bPaginate &&
    ...
    function _fnBuildAjax(oSettings, data, fn) {
      ...
      if ($.isPlainObject(oSettings.ajax) && oSettings.ajax.data) {
        ...
        var newData = $.isFunction(ajaxData) ? ajaxData(data) : // fn can manipulate data or return an object or array
      ...
      if (oSettings.fnServerData) {
        ...
        oSettings.jqXHR = oSettings.ajax.call(
          oSettings.oInstance,
          data,
          fn,
          oSettings,
    ...
    function _fnInfoMacros(oSettings, str) {
      ...
      // internally
      var iStart = oSettings.oScroll.bInfinite
          ? 1
    ...
    function _fnInitialise(oSettings) {
      ...
      if (
        (oSettings.sAjaxSource || oSettings.ajax) &&
        !oSettings.oFeatures.bServerSide
      ) {
        var aoData = [];
    ...
    function _fnFeatureHtmlLength(oSettings) {
      ...
      if (
        aLengthMenu.length == 2 && typeof aLengthMenu[0] === "object" &&
    ...
    function _fnFeatureHtmlTable(oSettings) {
      ...
      var nScroller = document.createElement("div"),
        ...
        nTfoot = oSettings.nTable.getElementsByTagName("tfoot").length === 0
          ? null
    ...
    function _fnScrollDraw(o) {
      var nScrollHeadInner = o.nScrollHead.getElementsByTagName("div")[0],
        ...
        aAppliedFooter = [],
        iSanityWidth,
        nScrollFootInner = (o.nTFoot !== null)
          ? o.nScrollFoot.getElementsByTagName("div")[0]
          : null,
        nScrollFootTable = (o.nTFoot !== null)
      ...
      nScrollHeadInner.style[padding] = bScrolling
      ...
      if (o.nTFoot !== null) {
        ...
        nScrollFootInner.style[padding] = bScrolling
          ? o.oScroll.iBarWidth + "px"
          : "0px";
      }
    ...
    function _fnCalculateColumnWidths(oSettings) {
      ...
      /* If the number of columns in the DOM equals the number that we have to process in 
		 ...
		 */
      if (
        iColums == oHeaders.length && iUserInputs === 0 &&
        ...
        for (i = 0; i < iColums; i++) {
          ...
          if (
            oColumn.bVisible && oColumn.sWidthOrig !== null &&
            oColumn.sWidthOrig !== ""
          ) {
          ...
          if (DataTable.ext.afnSortData[sDataType]) {
            ...
            if (aData.length === aoData.length) {
              ...
              _fnLog(
                oSettings,
                0,
                "Returned data sort array (col " + iColumn +
                  ") is the wrong length",
              );
            }
          }
        ...
        if (aoColumns[i].bSortable) {
          if (aSort.length > 0 && aSort[0].col == i) {
            ...
            var nextSort = (aoColumns[i].asSorting[aSort[0].index + 1])
              ? aoColumns[i].asSorting[aSort[0].index + 1]
          ...
          if (e.shiftKey) {
            ...
            if (bFound === false) {
              oSettings.aaSorting.push(
                [iDataIndex, oSettings.aoColumns[iDataIndex].asSorting[0], 0],
              );
            }
          } else {
      ...
      for (i = 0; i < oSettings.aoColumns.length; i++) {
        if (oSettings.aoColumns[i].bSortable) {
          ...
          if (oSettings.bJUI) {
            ...
            jqSpan.removeClass(
              oClasses.sSortJUIAsc + " " + oClasses.sSortJUIDesc + " " +
                oClasses.sSortJUI + " " + oClasses.sSortJUIAscAllowed + " " +
      ...
      if (oSettings.oFeatures.bSort && oSettings.oFeatures.bSortClasses) {
        ...
        for (i = 0, iLen = nTds.length; i < iLen; i++) {
          ...
          if (sTmpClass != sCurrentClass) {
            ...
            sNewClass.length > 0 && sCurrentClass.indexOf(sNewClass) == -1
          ) {
    ...
    function _fnLoadState(oSettings, oInit) {
      ...
      /* Reject old data */
      if (
        oData.iCreate < new Date().getTime() - (oSettings.iStateDuration * 1000)
      ) {
        return;
      }
    ...
    DataTable = function (oInit) {
      ...
      this.fnDestroy = function (bRemove) {
        ...
        if (
          oSettings.nTFoot && oSettings.nTable != oSettings.nTFoot.parentNode
        ) {
        ...
        if (iLen) {
          ...
          for (i = 0; i < iLen; i++) {
            anRows.filter(":nth-child(" + iLen + "n + " + i + ")").addClass(
      ...
      this.each(function () {
        ...
        for (i = 0, iLen = DataTable.settings.length; i < iLen; i++) {
          ...
          if (DataTable.settings[i].nTable == this) {
            var bRetrieve = oInit.bRetrieve !== undefined
              ? oInit.bRetrieve
              : DataTable.defaults.bRetrieve;
            var bDestroy = oInit.bDestroy !== undefined
              ? oInit.bDestroy
              : DataTable.defaults.bDestroy;
        ...
        if (
          tfoot.length === 0 && captions.length > 0 &&
          (oSettings.oScroll.sX !== "" || oSettings.oScroll.sY !== "")
        ) {
    ...
    DataTable.fnIsDataTable = function (nTable) {
      ...
      for (var i = 0; i < o.length; i++) {
        if (
          o[i].nTable === nTable || o[i].nScrollHead === nTable ||
    ...
    DataTable.models.oSettings = {
      ...
      "fnDisplayEnd": function () {
        if (this.oFeatures.bServerSide) {
          if (
            this.oFeatures.bPaginate === false || this._iDisplayLength == -1
          ) {
    ...
    $.extend(DataTable.ext.oPagination, {
      ...
      "two_button": {
        ...
        "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
          ...
          var sAppend = (!oSettings.bJUI)
            ? '<a class="' + oSettings.oClasses.sPagePrevDisabled +
              '" tabindex="' + oSettings.iTabIndex + '" role="button">' +
              oLang.sPrevious + "</a>" +
              '<a class="' + oSettings.oClasses.sPageNextDisabled +
              '" tabindex="' + oSettings.iTabIndex + '" role="button">' +
              oLang.sNext + "</a>"
            : '<a class="' + oSettings.oClasses.sPagePrevDisabled +
              '" tabindex="' + oSettings.iTabIndex +
              '" role="button"><span class="' +
              oSettings.oClasses.sPageJUIPrev + '"></span></a>' +
              '<a class="' + oSettings.oClasses.sPageNextDisabled +
              '" tabindex="' + oSettings.iTabIndex +
              '" role="button"><span class="' +
              oSettings.oClasses.sPageJUINext + '"></span></a>';
      ...
      "full_numbers": {
        ...
        "fnInit": function (oSettings, nPaging, fnCallbackDraw) {
          ...
          $(nPaging).append(
            '<a  tabindex="' + oSettings.iTabIndex + '" class="' +
        ...
        "fnUpdate": function (oSettings, fnCallbackDraw) {
          ...
          for (i = iStartButton; i <= iEndButton; i++) {
            sList += (iCurrentPage !== i)
              ? '<a tabindex="' + oSettings.iTabIndex + '" class="' +
                oClasses.sPageButton + '">' + oSettings.fnFormatNumber(i) +
                "</a>"
              : '<a tabindex="' + oSettings.iTabIndex + '" class="' +
                oClasses.sPageButtonActive + '">' +
                oSettings.fnFormatNumber(i) + "</a>";
          }
    ...
    $.extend(DataTable.ext.aTypes, [
      ...
      // HTML
      function (data) {
        return typeof data === "string" && data.indexOf("<") != -1 &&
            data.indexOf(">") != -1
          ? "html"
          : null;
      },
