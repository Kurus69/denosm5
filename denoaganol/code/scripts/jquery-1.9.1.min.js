...
*/ (function (e, t) {
  ...
  function M(e) {
    ...
    return b.isWindow(e) ? !1 : 1 === e.nodeType && t ? !0 : "array" === n ||
      "function" !== n &&
        ...
        if (r > 1) {
          for (s = Array(r), u = Array(r), l = Array(r); r > t; t++) {
            n[t] && b.isFunction(n[t].promise)
              ? n[t].promise().done(a(t, l, n)).fail(o.reject).progress(
                a(t, u, s),
              )
              : --i;
          }
    ...
    queue: function (e, n, r) {
      ...
      return e
        ? (n = (n || "fx") + "queue",
          i = b._data(e, n),
          r &&
          (!i || b.isArray(r) ? i = b._data(e, n, b.makeArray(r)) : i.push(r)),
          i || [])
        : t;
    },
    ...
    b.extend({
        ...
        select: {
          get: function (e) {
            ...
            for (; s > u; u++) {
              if (
                n = r[u],
                  !(!n.selected && u !== i || (b.support.optDisabled
                    ? n.disabled
      ...
      attr: function (e, n, r) {
        ...
        if (e && 3 !== u && 8 !== u && 2 !== u) {
          return typeof e.getAttribute === i
            ...
            : (a = 1 !== u || !b.isXMLDoc(e),
              a &&
              (n = n.toLowerCase(), o = b.attrHooks[n] || (J.test(n) ? z : I)),
              r === t
      ...
      attrHooks: {
        type: {
          set: function (e, t) {
            if (
              !b.support.radioValue && "radio" === t && b.nodeName(e, "input")
            ) {
              var n = e.value;
  ...
  b.event = {
      ...
      if (v) {
        ...
        while (l--) {
          s = rt.exec(n[l]) || [],
            ...
            (h = u[g] = [],
              h.delegateCount = 0,
              p.setup && p.setup.call(e, o, m, f) !== !1 || (e.addEventListener
      ...
      if (m && (c = m.events)) {
        ...
        while (l--) {
          if (
            ...
            while (o--) {
              a = f[o],
                !i && g !== a.origType || n && n.guid !== a.guid ||
      ...
      if (
        ...
        while ((l = h[d++]) && !n.isPropagationStopped()) {
          n.type = d > 1 ? c : p.bindType || g,
            ...
            s && s.apply(l, r),
            s = u && l[u],
            s && b.acceptData(l) && s.apply && s.apply(l, r) === !1 &&
            n.preventDefault();
        }
        if (
          n.type = g,
            !(a || n.isDefaultPrevented() ||
              ...
              "click" === g && b.nodeName(i, "a") || !b.acceptData(i) || !u ||
              !i[g] || b.isWindow(i))
        ) {
        ...
        while ((o = s[n++]) && !e.isPropagationStopped()) {
          ...
          while ((i = o.handlers[a++]) && !e.isImmediatePropagationStopped()) {
            (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
              (e.handleObj = i,
                e.data = i.data,
                r = ((b.event.special[i.origType] || {}).handle || i.handler)
                  .apply(o.elem, u),
                r !== t && (e.result = r) === !1 &&
      ...
      filter: function (e, n) {
        ...
        return null == e.pageX && null != n.clientX &&
          (i = e.target.ownerDocument || o,
            ...
            e.pageY = n.clientY + (a && a.scrollTop || r && r.scrollTop || 0) -
    ...
    special: {
      ...
      click: {
        trigger: function () {
          return b.nodeName(this, "input") && "checkbox" === this.type &&
              this.click
            ? (this.click(), !1)
            : t;
        },
      ...
      setup: function () {
        return Z.test(this.nodeName)
          ...
          : (b.event.add(this, "beforeactivate._change", function (e) {
            var t = e.target;
            Z.test(t.nodeName) && !b._data(t, "changeBubbles") &&
    ...
    b.fn.extend({
      on: function (e, n, r, i, o) {
        ...
        if (
          null == r && null == i ? (i = n, r = n = t) : null == i &&
    ...
    function (e, t) {
      var n,
        ...
        U = {
          ...
          PSEUDO: RegExp("^" + R),
          CHILD: RegExp(
            "^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + _ +
              "*(even|odd|(([+-]|)(\\d*)n|)" + _ + "*(?:([+-]|)" + _ +
              "*(\\d+)|))" + _ + "*\\)|)",
            "i",
          ),
          needsContext: RegExp(
            "^" + _ + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + _ +
              "*((?:-\\d)?\\d*)" + _ + "*\\)|)(?=[^-]|$)",
            "i",
          ),
        },
          ...
          return n !== p && 9 === n.nodeType && n.documentElement
            ? (p = n,
              ...
              T.getByName = at(function (e) {
                e.id = x + 0,
                  e.innerHTML = "<a name='" + x + "'></a><div name='" + x +
                    "'></div>",
              ...
              i.attrHandle = at(function (e) {
                  return e.innerHTML = "<a href='#'></a>",
                    e.firstChild && typeof e.firstChild.getAttribute !== A &&
              ...
              T.getIdNotName
                ...
                : (i.find.ID = function (e, n) {
                  ...
                  i.filter.ID = function (e) {
                    var t = e.replace(et, tt);
                    return function (e) {
                      var n = typeof e.getAttributeNode !== A &&
              ...
              v = f.compareDocumentPosition
                ? function (e, t) {
                  ...
                  : (r = t.compareDocumentPosition &&
                      e.compareDocumentPosition && e.compareDocumentPosition(t))
      ...
      o = st.getText = function (e) {
        ...
        i = st.selectors = {
          ...
          preFilter: {
            ...
            PSEUDO: function (e) {
              var t, n = !e[5] && e[2];
              return U.CHILD.test(e[0]) ? null
              : (e[4] ? e[2] = e[4] : n && z.test(n) && (t = ft(n, !0)) &&
          ...
          filter: {
            ...
            PSEUDO: function (e, t) {
              var n,
                r = i.pseudos[e] || i.setFilters[e.toLowerCase()] ||
                  st.error("unsupported pseudo: " + e);
              return r[x] ? r(t) : r.length > 1
                ? (n = [e, e, "", t],
      ...
      for (
        n in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }
      ) {
        i.pseudos[n] = lt(n);
      }
      ...
      function wt(e, t, n, r) {
        ...
        if (!r && 1 === p.length) {
          if (
            a = p[0] = p[0].slice(0),
              a.length > 2 && "ID" === (u = a[0]).type && 9 === t.nodeType &&
          ...
          while (o--) {
            ...
            if (
              ...
              if (
                a.splice(o, 1), e = r.length && dt(a), !e
              ) {
    ...
    if (1 === t.nodeType) {
      ...
      "script" === n && t.text !== e.text
        ...
        ? (t.parentNode && (t.outerHTML = e.outerHTML),
          b.support.html5Clone && e.innerHTML && !b.trim(t.innerHTML) &&
            ...
            a = typeof r,
              ...
              !(null == r || "number" === a && isNaN(r) ||
                ("number" !== a || b.cssNumber[u] || (r += "px"),
                  ...
                  0 !== n.indexOf("background") || (l[n] = "inherit"),
  ...
  function sn(e, t, n) {
    ...
    if (0 >= i || null == i) {
      if (
        i = Wt(e, t, o), (0 > i || null == i) && (i = e.style[t]), Yt.test(i)
      ) {
        return i;
      }
        ...
        ajax: function (e, n) {
          ...
          if (
            h.promise(N).complete = g.add,
              N.success = N.done,
              N.error = N.fail,
              p.url = ((e || p.url || yn) + "").replace(xn, "").replace(
                kn,
                mn[1] + "//",
              ),
          ...
          if (
            p.beforeSend && (p.beforeSend.call(f, N, p) === !1 || 2 === x)
          ) {
            return N.abort();
          }
          T = "abort";
          ...
          function k(e, n, r, i) {
            ...
            2 !== x &&
              (x = 2,
                ...
                N.statusCode(m),
                m = t,
                u && d.trigger(c ? "ajaxSuccess" : "ajaxError", [
                  N,
                  p,
                  c ? y : v,
                ]),
  ...
  b.ajaxSetup({
    ...
    b.ajaxPrefilter("json jsonp", function (n, r, i) {
      var o,
        ...
        s,
        u = n.jsonp !== !1 &&
          (Bn.test(n.url) ? "url" : "string" == typeof n.data &&
      ...
      return u || "jsonp" === n.dataTypes[0]
        ? (o = n.jsonpCallback = b.isFunction(n.jsonpCallback)
          ? n.jsonpCallback()
          : n.jsonpCallback,
          u ? n[u] = n[u].replace(Bn, "$1" + o) : n.jsonp !== !1 &&
  ...
  var Xn,
    ...
    Qn = {
      "*": [function (e, t) {
        ...
        if (o) {
          if (
            n = +o[2], r = o[3] || (b.cssNumber[e] ? "" : "px"), "px" !== r && s
          ) {
            s = b.css(i.elem, e, !0) || n || 1;
            do u = u || ".5", s /= u, b.style(i.elem, e, s + r); while (
              u !== (u = i.cur() / a) && 1 !== u && --l
            );
          }
  ...
  function nr(e, t, n) {
    ...
    (c = b._queueHooks(e, "fx"),
      ...
      (n.overflow = [d.overflow, d.overflowX, d.overflowY],
        "inline" === b.css(e, "display") && "none" === b.css(e, "float") &&
    ...
    b.fn.extend({
      ...
      offsetParent: function () {
        return this.map(function () {
          ...
          while (
            e && !b.nodeName(e, "html") && "static" === b.css(e, "position")
          ) {
            e = e.offsetParent;
          }
