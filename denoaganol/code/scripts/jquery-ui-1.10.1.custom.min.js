  ...
  e.extend(
    ...
    e.fn.extend({
      ...
      scrollParent: function () {
        var t;
        return e.ui.ie && /(static|relative)/.test(this.css("position")) ||
            /absolute/.test(this.css("position"))
          ? t = this.parents().filter(function () {
            return /(relative|absolute|fixed)/.test(e.css(this, "position")) &&
              /(auto|scroll)/.test(
                e.css(this, "overflow") + e.css(this, "overflow-y") +
        ...
        return o = !u && a.length
          ...
          u
            ? this.each(function () {
              ...
              if (!i) {
                return e.error(
                  "cannot call methods on " + n + " prior to initialization; " +
    ...
    e.widget(
      "ui.mouse",
      {
        ...
        _mouseDown: function (t) {
          ...
          var r = this,
            i = t.which === 1,
            s = typeof this.options.cancel == "string" && t.target.nodeName
        ...
        _mouseMove: function (t) {
          return e.ui.ie &&
              (!document.documentMode || document.documentMode < 9) && !t.button
            ? this._mouseUp(t)
            : this._mouseStarted
  ...
  e.position = {
    ...
    e.fn.position = function (t) {
      ...
      return y = d(b),
        ...
        S.length === 1 && (S[1] = S[0]),
        t.at[0] === "right" ? g.left += l
        : t.at[0] === "center" && (g.left += l / 2),
        t.at[1] === "bottom" ? g.top += v
      ...
      flip: {
        left: function (e, t) {
          var n = t.within,
            ...
            l = t.my[0] === "left" ? -t.elemWidth : t.my[0] === "right"
              ? t.elemWidth
              : 0,
            c = t.at[0] === "left" ? t.targetWidth : t.at[0] === "right"
              ? -t.targetWidth
              : 0,
            h = -2 * t.offset[0],
            p,
        ...
        top: function (e, t) {
          ...
          a < 0
            ? (v = e.top + c + h + p + t.collisionHeight - s - r,
              e.top + c + h + p > a && (v < 0 || v < i(a)) &&
              (e.top += c + h + p))
            : f > 0 &&
              (d = e.top - t.collisionPosition.marginTop + c + h + p - o,
                e.top + c + h + p > f && (d > 0 || i(d) < f) &&
                (e.top += c + h + p));
        },
      },
      flipfit: {
...
(function (e, t) {
  var n = 0, r = {}, i = {};
  r.height = r.paddingTop = r.paddingBottom = r.borderTopWidth = r
    .borderBottomWidth = "hide",
    i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i
      ...
      "ui.accordion",
      {
        ...
        _create: function () {
          ...
          this.prevShow = this.prevHide = e(),
            this.element.addClass("ui-accordion ui-widget ui-helper-reset")
              .attr("role", "tablist"),
            !t.collapsible && (t.active === !1 || t.active == null) &&
            (t.active = 0),
            this._processPanels(),
        ...
        _createIcons: function () {
          ...
          t &&
            (e("<span>").addClass(
              ...
              this.active.children(".ui-accordion-header-icon").removeClass(
                t.header,
        ...
        _destroy: function () {
          ...
          this.element.removeClass("ui-accordion ui-widget ui-helper-reset")
            ...
            ).removeAttr("role").removeAttr("aria-selected").removeAttr(
              "aria-controls",
            ).removeAttr("tabIndex").each(function () {
              /^ui-accordion/.test(this.id) && this.removeAttribute("id");
            }),
            this._destroyIcons(),
            e = this.headers.next().css("display", "").removeAttr("role")
        ...
        _setOption: function (e, t) {
          ...
          (this.options.event && this._off(this.headers, this.options.event),
            this._setupEvents(t)),
            this._super(e, t),
            e === "collapsible" && !t && this.options.active === !1 &&
            this._activate(0),
        ...
        _refresh: function () {
          var t,
            ...
            o = this.accordionId = "ui-accordion-" +
              (this.element.attr("id") || ++n);
          this.active = this._findActive(r.active).addClass(
            ...
            ).next().attr({ "aria-expanded": "false", "aria-hidden": "true" })
              .hide(),
            this.active.length
              ? this.active.attr({ "aria-selected": "true", tabIndex: 0 })
                .next().attr(
        ...
        _eventHandler: function (t) {
          ...
          t.preventDefault();
          if (
            s && !n.collapsible || this._trigger("beforeActivate", t, f) === !1
          ) {
            return;
          }
          n.active = o ? !1 : this.headers.index(i),
            ...
            n.icons &&
            r.children(".ui-accordion-header-icon").removeClass(
              n.icons.activeHeader,
            ).addClass(n.icons.header),
            s ||
            (i.removeClass("ui-corner-all").addClass(
              "ui-accordion-header-active ui-state-active ui-corner-top",
            ),
              n.icons &&
              i.children(".ui-accordion-header-icon").removeClass(
                n.icons.header,
    ...
    "ui.autocomplete",
    {
      ...
      _create: function () {
        ...
        this.isMultiLine = s
          ...
          this._initSource(),
          this.menu = e("<ul>").addClass("ui-autocomplete ui-front").appendTo(
            this._appendTo(),
          ).menu({ input: e(), role: null }).hide().data("ui-menu"),
              ...
              e(t.target).closest(".ui-menu-item").length ||
                this._delay(function () {
                  ...
                  this.document.one("mousedown", function (r) {
                    r.target !== t.element[0] && r.target !== n &&
                      !e.contains(n, r.target) && t.close();
                  });
                });
            },
      ...
      e.ui.autocomplete,
      {
        ...
        __response: function (e) {
          ...
          e && e.length
            ...
            : t = this.options.messages.noResults, this.liveRegion.text(t);
        },
      },
    );
})(jQuery);
    ...
    "ui.button",
    {
      ...
      _create: function () {
        ...
        var t = this,
          ...
          h = "ui-state-focus";
        u.label === null &&
        (u.label = this.type === "input"
          ? this.buttonElement.val()
          : this.buttonElement.html()),
          this._hoverable(this.buttonElement),
          this.buttonElement.addClass(o).attr("role", "button").bind(
      ...
      _destroy: function () {
        this.element.removeClass("ui-helper-hidden-accessible"),
          this.buttonElement.removeClass(o + " " + u + " " + a).removeAttr(
            "role",
        ...
        t !== this.options.disabled && this._setOption("disabled", t),
          this.type === "radio"
            ? l(this.element[0]).each(function () {
              e(this).is(":checked")
                ? e(this).button("widget").addClass("ui-state-active").attr(
                  "aria-pressed",
                  "true",
                )
                : e(this).button("widget").removeClass("ui-state-active").attr(
                  "aria-pressed",
                  "false",
                );
            })
      ...
      _resetButton: function () {
        ...
        var t = this.buttonElement.removeClass(a),
          n = e("<span></span>", this.document[0]).addClass("ui-button-text")
            .html(this.options.label).appendTo(t.empty()).text(),
          r = this.options.icons,
          i = r.primary && r.secondary,
          s = [];
        r.primary || r.secondary
          ? (this.options.text && s.push(
            "ui-button-text-icon" +
              (i ? "s" : r.primary ? "-primary" : "-secondary"),
          ),
            r.primary &&
            t.prepend(
              "<span class='ui-button-icon-primary ui-icon " + r.primary +
                "'></span>",
            ),
            r.secondary &&
            t.append(
              "<span class='ui-button-icon-secondary ui-icon " + r.secondary +
                "'></span>",
            ),
            this.options.text || (s.push(
    ...
    e.widget(
      "ui.buttonset",
      {
        ...
        refresh: function () {
          ...
          this.buttons = this.element.find(this.options.items).filter(
            ":ui-button",
        ...
        _destroy: function () {
          this.element.removeClass("ui-buttonset"),
            this.buttons.map(function () {
              return e(this).button("widget")[0];
            }).removeClass("ui-corner-left ui-corner-right").end().button(
              "destroy",
            );
        },
      },
  ...
  function o(t) {
    ...
    return t.delegate(n, "mouseout", function () {
      ...
      e.datepicker._isDisabledDatepicker(
        ...
        (e(this).parents(".ui-datepicker-calendar").find("a").removeClass(
          "ui-state-hover",
        ),
    ...
    s.prototype,
    {
      ...
      _connectDatepicker: function (t, r) {
        ...
        this._attachments(i, r),
          i.addClass(this.markerClassName).keydown(this._doKeyDown).keypress(
            this._doKeyPress,
          ).keyup(this._doKeyUp),
          this._autoSize(r),
          e.data(t, n, r),
          ...
          i = this._get(n, "buttonText"),
            ...
            n.trigger = e(
              this._get(n, "buttonImageOnly")
                ...
                : e("<button type='button'></button>").addClass(
                  this._triggerClass,
      ...
      _destroyDatepicker: function (t) {
        ...
        r = t.nodeName.toLowerCase(),
          ...
          r === "input"
            ? (s.append.remove(),
              s.trigger.remove(),
              i.removeClass(this.markerClassName).unbind(
                "focus",
      ...
      _enableDatepicker: function (t) {
        ...
        if (r === "input") {
          ...
          i = s.children("." + this._inlineClass),
            ...
            i.find("select.ui-datepicker-month, select.ui-datepicker-year")
              .prop("disabled", !1);
        }
      ...
      _optionDatepicker: function (n, r, i) {
        ...
        if (arguments.length === 2 && typeof r == "string") {
          return r === "defaults"
            ...
            : l
            ? r === "all" ? e.extend({}, l.settings) : this._get(l, r)
            : null;
        }
        s = r || {},
          ...
          (this._curInst === l && this._hideDatepicker(),
            ...
            u(l.settings, s),
            a !== null && s.dateFormat !== t && s.minDate === t &&
            (l.settings.minDate = this._formatDate(l, a)),
            f !== null && s.dateFormat !== t && s.maxDate === t &&
      ...
      _doKeyDown: function (t) {
        ...
        if (e.datepicker._datepickerShowing) {
          switch (t.keyCode) {
            ...
            case 13:
              return i = e(
                "td." + e.datepicker._dayOverClass + ":not(." +
      ...
      _doKeyPress: function (t) {
        ...
        if (e.datepicker._get(i, "constrainInput")) {
          return n = e.datepicker._possibleChars(
      ...
      _showDatepicker: function (t) {
        ...
        n = e.datepicker._getInst(t),
          e.datepicker._curInst && e.datepicker._curInst !== n &&
          (e.datepicker._curInst.dpDiv.stop(!0, !0),
            n && e.datepicker._datepickerShowing &&
        ...
        u(n.settings, i),
          ...
          (a = e.datepicker._get(n, "showAnim"),
            ...
            n.input.is(":visible") && !n.input.is(":disabled") &&
            n.input.focus(),
      ...
      _updateDatepicker: function (t) {
        ...
        t.dpDiv.removeClass(
          ...
          t === e.datepicker._curInst && e.datepicker._datepickerShowing &&
          t.input && t.input.is(":visible") && !t.input.is(":disabled") &&
          t.input[0] !== document.activeElement && t.input.focus(),
          t.yearshtml && (n = t.yearshtml,
            setTimeout(function () {
              n === t.yearshtml && t.yearshtml &&
              t.dpDiv.find("select.ui-datepicker-year:first").replaceWith(
                t.yearshtml,
              ), n = t.yearshtml = null;
            }, 0));
      },
      ...
      _checkOffset: function (t, n, r) {
        ...
        return n.left -= this._get(t, "isRTL") ? i - o : 0,
          n.left -= r && n.left === t.input.offset().left
            ? e(document).scrollLeft()
            : 0,
          n.top -= r && n.top === t.input.offset().top + u
      ...
      _hideDatepicker: function (t) {
        ...
        this._datepickerShowing &&
          (r = this._get(u, "showAnim"),
            ...
            o && o.apply(u.input ? u.input[0] : null, [
              u.input ? u.input.val() : "",
              u,
            ]),
      ...
      _tidyDialog: function (e) {
        e.dpDiv.removeClass(this._dialogClass).unbind(
      ...
      _checkExternalClick: function (t) {
        ...
        (n[0].id !== e.datepicker._mainDivId &&
          ...
          n.hasClass(e.datepicker.markerClassName) &&
            e.datepicker._curInst !== r) && e.datepicker._hideDatepicker();
      },
      ...
      parseDate: function (t, n, r) {
        ...
        d === -1 ? d = (new Date()).getFullYear() : d < 100 &&
          (d += (new Date()).getFullYear() -
            (new Date()).getFullYear() % 100 + (d <= f ? 0 : -100));
        if (g > -1) {
          v = 1, m = g;
          do {
        ...
        if (
          b.getFullYear() !== d || b.getMonth() + 1 !== v || b.getDate() !== m
        ) {
          throw "Invalid date";
        }
        return b;
                  ...
                  c += f(
                    ...
                    Math.round(
                      ((new Date(t.getFullYear(), t.getMonth(), t.getDate()))
                        .getTime() -
                        (new Date(t.getFullYear(), 0, 0)).getTime()) / 864e5,
                    ),
                    3,
                  );
                  break;
      ...
      _setDate: function (e, t, n) {
        ...
        e.selectedDay = e.currentDay = o.getDate(),
          ...
          (i !== e.selectedMonth || s !== e.selectedYear) && !n &&
      ...
      _attachHandlers: function (t) {
        ...
        t.dpDiv.find("[data-handler]").map(function () {
          var t = {
            ...
            selectDay: function () {
              return window["DP_jQuery_" + r].datepicker._selectDay(
                i,
            ...
            selectMonth: function () {
              return window["DP_jQuery_" + r].datepicker._selectMonthYear(
                i,
                this,
                "M",
              ),
        ...
        e.drawMonth = Z,
          ...
          r = this._canAdjustMonth(e, -1, et, Z)
            ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" +
              n + "'><span class='ui-icon ui-icon-circle-triangle-" + (U
                ? "e"
                : "w") +
              "'>" + n + "</span></a>"
            : W
            ...
            for (E = 0; E < 7; E++) {
              A = (E + l) % 7,
                L += "<th" + ((E + l + 6) % 7 >= 5
                  ...
                  : "") +
                  ">" + "<span title='" + h[A] + "'>" + p[A] + "</span></th>";
            }
            k += L + "</tr></thead><tbody>",
              O = this._getDaysInMonth(et, Z),
              et === e.selectedYear && Z === e.selectedMonth &&
              ...
              k += "<tr>",
                B = c
                  ? "<td class='ui-datepicker-week-col'>" +
                    this._get(e, "calculateWeek")(P) + "</td>"
                  : "";
              for (E = 0; E < 7; E++) {
                j = m ? m.apply(e.input ? e.input[0] : null, [P]) : [!0, ""],
                  F = P.getMonth() !== Z,
                  I = F && !y || !j[0] || G && P < G || Y && P > Y,
                  B += "<td class='" + ((E + l + 6) % 7 >= 5
                    ? " ui-datepicker-week-end"
                    : "") +
                    (F ? " ui-datepicker-other-month" : "") +
                    (P.getTime() === N.getTime() && Z === e.selectedMonth &&
                          e._keyEvent ||
                        b.getTime() === P.getTime() &&
                          b.getTime() === N.getTime()
                      ? " " + this._dayOverClass
                    ...
                    (I
                      ...
                      : " data-handler='selectDay' data-event='click' data-month='" +
                        P.getMonth() + "' data-year='" + P.getFullYear() +
                        "'") +
                    ">" + (F && !g
                      ? "&#xa0;"
                      : I
                      ? "<span class='ui-state-default'>" + P.getDate() +
                        "</span>"
      ...
      _generateMonthYearHeader: function (e, t, n, r, i, s, o, u) {
        ...
        if (s || !m) {
          ...
          for (l = 0; l < 12; l++) {
            (!a || l >= r.getMonth()) && (!f || l <= i.getMonth()) &&
              (w += "<option value='" + l + "'" + (l === t
                ? " selected='selected'"
                : "") +
                ">" + u[l] + "</option>");
          }
        ...
        if (!e.yearshtml) {
          ...
          if (s || !g) b += "<span class='ui-datepicker-year'>" + n + "</span>";
            ...
            for (; d <= v; d++) {
              e.yearshtml += "<option value='" + d + "'" + (d === n
                ? " selected='selected'"
                : "") +
                ">" + d + "</option>";
            }
      ...
      _adjustInstDate: function (e, t, n) {
        var r = e.drawYear + (n === "Y" ? t : 0),
          ...
          s = Math.min(e.selectedDay, this._getDaysInMonth(r, i)) +
            (n === "D" ? t : 0),
      ...
      _isInRange: function (e, t) {
        ...
        return a &&
          ...
          (!s || t.getTime() <= s.getTime()) && (!o || t.getFullYear() >= o) &&
          (!u || t.getFullYear() <= u);
      },
  ...
  e.widget(
    "ui.dialog",
    {
      ...
      _createWrapper: function () {
        ...
        ).hide().attr({ tabIndex: -1, role: "dialog" }).appendTo(
          this._appendTo(),
        ),
          this._on(this.uiDialog, {
            keydown: function (t) {
              if (
                this.options.closeOnEscape && !t.isDefaultPrevented() &&
                t.keyCode && t.keyCode === e.ui.keyCode.ESCAPE
              ) {
              ...
              t.target !== i[0] && t.target !== this.uiDialog[0] || !!t.shiftKey
                ? (t.target === r[0] || t.target === this.uiDialog[0]) &&
                  t.shiftKey && (i.focus(1), t.preventDefault())
      ...
      _createButtonPane: function () {
        this.uiDialogButtonPane = e("<div>").addClass(
          ...
          this.uiButtonSet = e("<div>").addClass("ui-dialog-buttonset")
      ...
      _size: function () {
        ...
        this.element.show().css(
          ...
          e = this.uiDialog.css({ height: "auto", width: r.width })
            .outerHeight(),
          t = Math.max(0, r.minHeight - e),
          n = typeof r.maxHeight == "number"
          ...
          e.ui.dialog.overlayInstances &&
            this.document.bind("focusin.dialog", function (t) {
              !e(t.target).closest(".ui-dialog").length &&
                ...
                (t.preventDefault(),
                  e(".ui-dialog:visible:last .ui-dialog-content").data(
                    "ui-dialog",
                  )._focusTabbable());
            });
        }),
          this.overlay = e("<div>").addClass("ui-widget-overlay ui-front")
  ...
  e.widget(
    ...
    e.ui.mouse,
    {
      ...
      _mouseStart: function (t) {
        ...
        return this.helper = this._createHelper(t),
          ...
          this._trigger("start", t) === !1
            ? (this._clear(), !1)
            : (this._cacheHelperProportions(),
              e.ui.ddmanager && !n.dropBehaviour &&
      ...
      _getHandle: function (t) {
        var n =
          !this.options.handle || !e(this.options.handle, this.element).length
            ? !0
            : !1;
        return e(this.options.handle, this.element).find("*").addBack().each(
          function () {
            this === t.target && (n = !0);
          },
        ),
      ...
      _adjustOffsetFromHelper: function (t) {
        typeof t == "string" && (t = t.split(" ")),
          ...
          "right" in t &&
          (this.offset.click.left = this.helperProportions.width - t.right +
            this.margins.left),
          "top" in t && (this.offset.click.top = t.top + this.margins.top),
          "bottom" in t &&
          (this.offset.click.top = this.helperProportions.height - t.bottom +
            this.margins.top);
      },
      _getParentOffset: function () {
        ...
        if (
          ...
          this.offsetParent[0].tagName &&
            this.offsetParent[0].tagName.toLowerCase() === "html" && e.ui.ie
        ) {
          t = { top: 0, left: 0 };
        }
        return {
        ...
        if (i.containment === "document" || i.containment === "window") {
          this.containment = [
            i.containment === "document"
              ? 0
              : e(window).scrollLeft() - this.offset.relative.left -
                this.offset.parent.left,
            i.containment === "document"
              ? 0
              : e(window).scrollTop() - this.offset.relative.top -
      ...
      _convertPositionTo: function (t, n) {
        ...
        return {
          top: n.top + this.offset.relative.top * r +
            this.offset.parent.top * r - (this.cssPosition === "fixed"
                  ? -this.scrollParent.scrollTop()
                  : s
                  ? 0
                  : i.scrollTop()) * r,
          left: n.left + this.offset.relative.left * r +
            this.offset.parent.left * r - (this.cssPosition === "fixed"
                  ? -this.scrollParent.scrollLeft()
                  : s
                  ? 0
                  : i.scrollLeft()) * r,
        ...
        return this.originalPosition &&
                ...
                : s)),
          {
            top: l - this.offset.click.top - this.offset.relative.top -
              this.offset.parent.top + (this.cssPosition === "fixed"
                ? -this.scrollParent.scrollTop()
                : a
                ? 0
                : u.scrollTop()),
            left: f - this.offset.click.left - this.offset.relative.left -
              this.offset.parent.left + (this.cssPosition === "fixed"
                ? -this.scrollParent.scrollLeft()
                : a
                ? 0
                : u.scrollLeft()),
            ...
            s
              ? (this.instance.isOver ||
                (this.instance.isOver = 1,
                  this.instance.currentItem = e(i).clone().removeAttr("id")
                  ...
                  this.instance.offset.parent.left -= r.offset.parent.left -
                    this.instance.offset.parent.left,
                  this.instance.offset.parent.top -= r.offset.parent.top -
    ...
    e.ui.plugin.add("draggable", "scroll", {
      ...
      drag: function (t) {
        ...
        if (
          ...
          if (!r.axis || r.axis !== "x") {
            n.overflowOffset.top + n.scrollParent[0].offsetHeight - t.pageY <
                r.scrollSensitivity
              ? n.scrollParent[0].scrollTop = i = n.scrollParent[0].scrollTop +
                r.scrollSpeed
        ...
        i !== !1 && e.ui.ddmanager && !r.dropBehaviour &&
  ...
  e.widget(
      ...
      _drop: function (t, n) {
        ...
        return !r || (r.currentItem || r.element)[0] === this.element[0]
          ...
          : (this.element.find(":data(ui-droppable)").not(
            ...
            if (
              t.options.greedy && !t.options.disabled &&
    ...
    e.ui.intersect = function (e, t, r) {
      ...
      switch (r) {
        ...
        case "touch":
          return (a >= h && a <= p || f >= h && f <= p || a < h && f > p) &&
    ...
    e.ui.ddmanager = {
      ...
      prepareOffsets: function (t, n) {
        var r,
          ...
          o = n ? n.type : null,
          u = (t.currentItem || t.element).find(":data(ui-droppable)")
            .addBack();
        e:
        for (r = 0; r < s.length; r++) {
          if (
            s[r].options.disabled ||
            t && !s[r].accept.call(s[r].element[0], t.currentItem || t.element)
          ) {
            continue;
          }
  ...
  e.effects = { effect: {} },
              ...
              return n instanceof s
                ...
                : c(o, function (t, r) {
                  ...
                  c(r.props, function (e, t) {
                    ...
                    a[i] && e.inArray(null, a[i].slice(0, 3)) < 0 &&
          ...
          s.fn[n] = function (n) {
            ...
            c(o, function (t, i) {
              ...
              s.fn[t] = function (s) {
                ...
                return o === "undefined"
                  ? f
                  : (o === "function" && (s = s.call(this, f), o = e.type(s)),
                    s == null && i.empty ? this : (o === "string" &&
                      (l = r.exec(s),
                        l &&
          ...
          c(n, function (t, n) {
            e.cssHooks[n] = {
              set: function (t, r) {
                var i, o, u = "";
                if (
                  r !== "transparent" && (e.type(r) !== "string" || (i = p(r)))
                ) {
                  r = s(i || r);
              ...
              e.fx.step[n] = function (t) {
                t.colorInit ||
                (t.start = s(t.elem, n), t.end = s(t.end), t.colorInit = !0),
    ...
    function () {
      ...
      function s(t, n) {
        ...
        for (s in n) {
          o = n[s],
            t[s] !== o && !r[s] && (e.fx.step[s] || !isNaN(parseFloat(o))) &&
            (i[s] = o);
        }
        return i;
      }
        ...
        e.fn.extend(
          {
            ...
            addClass: function (t, n, r, i) {
              return n ? e.effects.animateClass.call(this, { add: t }, n, r, i)
              : this._addClass(t);
            },
    ...
    function () {
      ...
      function i(t) {
        return !t || typeof t == "number" || e.fx.speeds[t] ? !0
      ...
      e.extend(e.effects, {
        ...
        e.fn.extend({
          effect: function () {
            ...
            return e.fx.off || !s
              ? n ? this[n](t.duration, t.complete) : this.each(function () {
    ...
    function () {
      ...
      e.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, n) {
        ...
        e.extend(t, {
          ...
          Elastic: function (e) {
            return e === 0 || e === 1 ? e : -Math.pow(2, 8 * (e - 1)) *
  ...
  e.effects.effect.puff = function (t, n) {
    ...
    e.effects.effect.scale = function (t, n) {
      ...
      i.effect = "size",
        ...
        i.from = t.from ||
          (s === "show" ? { height: 0, width: 0, outerHeight: 0, outerWidth: 0 }
          : f),
        i.to = {
          height: f.height * l.y,
          width: f.width * l.x,
    ...
    e.effects.effect.size = function (t, n) {
      ...
      (v === "content" || v === "both") && s.from.y !== s.to.y &&
...
(function (e, t) {
  e.effects.effect.transfer = function (t, n) {
    var r = e(this),
      ...
      c = r.offset(),
      h = e("<div class='ui-effects-transfer'></div>").appendTo(document.body)
        .addClass(t.className).css(
          {
            top: c.top - u,
            left: c.left - a,
    ...
    "ui.menu",
    {
      ...
      _create: function () {
        this.activeMenu = this.element,
          this.mouseHandled = !1,
          this.element.uniqueId().addClass(
            "ui-menu ui-widget ui-widget-content ui-corner-all",
          ).toggleClass("ui-menu-icons", !!this.element.find(".ui-icon").length)
            .attr({ role: this.options.role, tabIndex: 0 }).bind(
              "click" + this.eventNamespace,
              e.proxy(function (e) {
          ...
          this._on({
            ...
            "click .ui-menu-item:has(a)": function (t) {
              ...
              !this.mouseHandled && n.not(".ui-state-disabled").length &&
                (this.mouseHandled = !0,
                  this.select(t),
            ...
            "mouseenter .ui-menu-item": function (t) {
              ...
              n.siblings().children(".ui-state-active").removeClass(
                "ui-state-active",
              ), this.focus(t, n);
            },
      ...
      _destroy: function () {
        this.element.removeAttr("aria-activedescendant").find(".ui-menu")
          ...
          ).removeAttr("role").removeAttr("tabIndex").removeAttr(
            "aria-labelledby",
          ).removeAttr("aria-expanded").removeAttr("aria-hidden").removeAttr(
            "aria-disabled",
          ).removeUniqueId().show(),
          this.element.find(".ui-menu-item").removeClass("ui-menu-item")
            .removeAttr("role").removeAttr("aria-disabled").children("a")
            .removeUniqueId().removeClass("ui-corner-all ui-state-hover")
            .removeAttr("tabIndex").removeAttr("role").removeAttr(
              "aria-haspopup",
        ...
        switch (t.keyCode) {
          ...
          default:
            u = !1,
              ...
              n = s && n.index(this.active.next()) !== -1
      ...
      refresh: function () {
        ...
        r.filter(":not(.ui-menu)").addClass(
          ...
          var t = e(this),
            r = t.prev("a"),
            i = e("<span>").addClass("ui-menu-icon ui-icon " + n).data(
          ...
          t.children(":not(.ui-menu-item):has(a)").addClass("ui-menu-item")
            .attr("role", "presentation").children("a").uniqueId().addClass(
              "ui-corner-all",
          ...
          this.active && !e.contains(this.element[0], this.active[0]) &&
          this.blur();
      },
      _itemRole: function () {
      ...
      _open: function (t) {
        ...
        clearTimeout(this.timer),
          this.element.find(".ui-menu").not(t.parents(".ui-menu")).hide().attr(
            "aria-hidden",
            "true",
          ),
          t.show().removeAttr("aria-hidden").attr("aria-expanded", "true")
            .position(n);
      },
      ...
      _close: function (e) {
        e || (e = this.active ? this.active.parent() : this.element),
          e.find(".ui-menu").hide().attr("aria-hidden", "true").attr(
            "aria-expanded",
            "false",
      ...
      _move: function (e, t, n) {
        ...
        this.active &&
          (e === "first" || e === "last"
            ? r = this.active[e === "first" ? "prevAll" : "nextAll"](
              ".ui-menu-item",
            ).eq(-1)
      ...
      nextPage: function (t) {
        ...
        this._hasScroll()
          ...
          : this.focus(
            t,
            this.activeMenu.children(".ui-menu-item")[
  ...
  e.widget(
    "ui.progressbar",
    {
      ...
      _destroy: function () {
        this.element.removeClass(
          "ui-progressbar ui-widget ui-widget-content ui-corner-all",
        ).removeAttr("role").removeAttr("aria-valuemin").removeAttr(
          "aria-valuemax",
    ...
    e.ui.mouse,
    {
      ...
      _create: function () {
        ...
        this.element.addClass("ui-resizable"),
          e.extend(
            this,
            {
              ...
              _helper: u.helper || u.ghost || u.animate
        ...
        this._renderAxis = function (t) {
          ...
          u.autoHide &&
          (this._handles.hide(),
            e(this.element).addClass("ui-resizable-autohide").mouseenter(
              function () {
                if (u.disabled) return;
      ...
      _mouseStop: function (t) {
        ...
        return this._helper &&
          (n = this._proportionallyResizeElements,
            ...
            u = parseInt(l.element.css("left"), 10) +
                (l.position.left - l.originalPosition.left) || null,
            a = parseInt(l.element.css("top"), 10) +
        ...
        for (e = 0; e < this._proportionallyResizeElements.length; e++) {
          ...
          if (!this.borderDif) {
            ...
            for (t = 0; t < n.length; t++) {
              this.borderDif[t] = (parseInt(n[t], 10) || 0) +
                (parseInt(r[t], 10) || 0);
            }
          }
          i.css(
    ...
    e.ui.plugin.add("resizable", "animate", {
      stop: function (t) {
        var n = e(this).data("ui-resizable"),
          ...
          f = parseInt(n.element.css("left"), 10) +
              (n.position.left - n.originalPosition.left) || null,
          l = parseInt(n.element.css("top"), 10) +
              (n.position.top - n.originalPosition.top) || null;
        n.element.animate(
          e.extend(a, l && f ? { top: l, left: f } : {}),
          {
    ...
    e.ui.plugin.add("resizable", "containment", {
      start: function () {
        var t,
          ...
          c = f.element,
          h = l.containment,
          p = h instanceof e ? h.get(0) : /parent/.test(h)
            ? c.parent().get(0)
            : h;
        if (!p) return;
      ...
      resize: function (t) {
        ...
        h[0] !== document && /static/.test(h.css("position")) && (c = a),
          ...
          (o.size.width = o.size.width + (o._helper
      ...
      stop: function () {
        ...
        t._helper && !n.animate && /relative/.test(s.css("position")) &&
        e(this).css({ left: u.left - i.left - r.left, width: a, height: f }),
          t._helper && !n.animate && /static/.test(s.css("position")) &&
          e(this).css({ left: u.left - i.left - r.left, width: a, height: f });
      },
    }),
      ...
      resize: function () {
        ...
        n.grid = u,
          ...
          /^(se|s|e)$/.test(o)
            ...
            : /^(ne)$/.test(o)
            ? (t.size.width = h, t.size.height = p, t.position.top = s.top - c)
            : /^(sw)$/.test(o)
            ? (t.size.width = h,
              t.size.height = p,
      ...
      _mouseStart: function (t) {
        ...
        this.selectees = e(r.filter, this.element[0]),
          ...
          e(t.target).parents().addBack().each(function () {
            ...
            if (i) {
              return r = !t.metaKey && !t.ctrlKey ||
                !i.$element.hasClass("ui-selected"),
                i.$element.removeClass(r ? "ui-unselecting" : "ui-selected")
          ...
          this.selectees.each(function () {
            ...
            i.tolerance === "touch"
              ...
              f
                ...
                : (n.selecting && ((t.metaKey || t.ctrlKey) && n.startselected
                  ...
                  : (n.$element.removeClass("ui-selecting"),
                    n.selecting = !1,
                    n.startselected &&
                    (n.$element.addClass("ui-unselecting"), n.unselecting = !0),
                    r._trigger("unselecting", t, { unselecting: n.element }))),
                  n.selected && !t.metaKey && !t.ctrlKey && !n.startselected &&
    ...
    e.ui.mouse,
    {
      ...
      _create: function () {
        this._keySliding = !1,
          ...
          this._mouseInit(),
          this.element.addClass(
            "ui-slider ui-slider-" + this.orientation + " ui-widget" +
      ...
      _createHandles: function () {
        var t,
          n,
          r = this.options,
          i = this.element.find(".ui-slider-handle").addClass(
        ...
        return c.disabled ? !1 : (this.elementSize = {
          ...
          u === !1
            ...
            : (this._mouseSliding = !0,
              ...
              this._clickOffset = f ? { left: 0, top: 0 } : {
                left: t.pageX - a.left - s.width() / 2,
                top: t.pageY - a.top - s.height() / 2 -
      ...
      _normValueFromMouse: function (e) {
        ...
        return this.orientation === "horizontal"
          ? (t = this.elementSize.width,
            n = e.x - this.elementOffset.left -
              (this._clickOffset ? this._clickOffset.left : 0))
          : (t = this.elementSize.height,
            n = e.y - this.elementOffset.top -
      ...
      _slide: function (e, t, n) {
        ...
        this.options.values && this.options.values.length
          ? (r = this.values(t ? 0 : 1),
            this.options.values.length === 2 && this.options.range === !0 &&
            (t === 0 && n > r || t === 1 && n < r) && (n = r),
            n !== this.values(t) &&
            (i = this.values(),
              i[t] = n,
      ...
      _refreshValue: function () {
        ...
        this.options.values && this.options.values.length
          ...
          : (r = this.value(),
            ...
            o === "min" && this.orientation === "vertical" &&
            this.range.stop(1, 1)[f ? "animate" : "css"](
              { height: n + "%" },
              u.animate,
            ),
            o === "max" && this.orientation === "vertical" && this.range[
              f ? "animate" : "css"
            ]({ height: 100 - n + "%" }, { queue: !1, duration: u.animate }));
      },
      _handleEvents: {
        keydown: function (t) {
    ...
    e.ui.mouse,
    {
      ...
      _mouseStart: function (t, n, r) {
        ...
        return e.ui.ddmanager && (e.ui.ddmanager.current = this),
          e.ui.ddmanager && !s.dropBehaviour &&
          e.ui.ddmanager.prepareOffsets(this, t),
          this.dragging = !0,
      ...
      _mouseDrag: function (t) {
          ...
          (this.scrollParent[0] !== document &&
            ...
            ? (this.overflowOffset.top + this.scrollParent[0].offsetHeight -
              ...
              : t.pageY - this.overflowOffset.top < o.scrollSensitivity &&
                (this.scrollParent[0].scrollTop = u =
                  this.scrollParent[0].scrollTop - o.scrollSpeed),
              this.overflowOffset.left + this.scrollParent[0].offsetWidth -
            ...
            u !== !1 && e.ui.ddmanager && !o.dropBehaviour &&
            e.ui.ddmanager.prepareOffsets(this, t)),
          this.positionAbs = this._convertPositionTo("absolute");
        if (!this.options.axis || this.options.axis !== "y") {
          this.helper[0].style.left = this.position.left + "px";
        ...
        for (n = this.items.length - 1; n >= 0; n--) {
          ...
          if (
            i !== this.currentItem[0] && this.placeholder[
                s === 1 ? "next" : "prev"
              ]()[0] !== i &&
      ...
      _mouseStop: function (t, n) {
        ...
        if (this.options.revert) {
          ...
          this.reverting = !0,
            e(this.helper).animate(
              {
                left: i.left - this.offset.parent.left - this.margins.left +
                  (this.offsetParent[0] === document.body
                    ? 0
                    : this.offsetParent[0].scrollLeft),
                top: i.top - this.offset.parent.top - this.margins.top +
                  (this.offsetParent[0] === document.body
                    ? 0
      ...
      _getItemsAsjQuery: function (t) {
          ...
          for (n = a.length - 1; n >= 0; n--) {
            ...
            for (r = i.length - 1; r >= 0; r--) {
              s = e.data(i[r], this.widgetFullName),
                s && s !== this && !s.options.disabled &&
                u.push([
                  e.isFunction(s.options.items)
                    ? s.options.items.call(s.element)
                    : e(s.options.items, s.element).not(".ui-sortable-helper")
        ...
        u.push([
          e.isFunction(this.options.items)
            ...
            : e(this.options.items, this.element).not(".ui-sortable-helper")
              .not(".ui-sortable-placeholder"),
          this,
        ]);
      ...
      refreshPositions: function (t) {
        ...
        for (n = this.items.length - 1; n >= 0; n--) {
          r = this.items[n];
          if (
            r.instance !== this.currentContainer && this.currentContainer &&
        ...
        if (this.options.custom && this.options.custom.refreshContainers) {
          ...
          for (n = this.containers.length - 1; n >= 0; n--) {
            s = this.containers[n].element.offset(),
              ...
              this.containers[n].containerCache.width = this.containers[n]
                .element.outerWidth(),
              this.containers[n].containerCache.height = this.containers[n]
                .element.outerHeight();
          }
        }
        return this;
        ...
        if (!r.placeholder || r.placeholder.constructor === String) {
          n = r.placeholder,
            r.placeholder = {
              element: function () {
                var r =
                  e(document.createElement(t.currentItem[0].nodeName)).addClass(
                    n ||
      ...
      _contactContainers: function (t) {
        ...
        for (n = this.containers.length - 1; n >= 0; n--) {
          if (
            e.contains(this.currentItem[0], this.containers[n].element[0])
          ) {
            continue;
          }
          if (this._intersectsWith(this.containers[n].containerCache)) {
            if (
              c && e.contains(this.containers[n].element[0], c.element[0])
            ) {
              continue;
            }
        ...
        if (
          ...
          for (r = this.items.length - 1; r >= 0; r--) {
            if (
              !e.contains(this.containers[h].element[0], this.items[r].item[0])
            ) {
              continue;
            }
      ...
      _setContainment: function () {
        ...
        /^(document|window|parent)$/.test(i.containment) ||
          (t = e(i.containment)[0],
            ...
            this.containment = [
              n.left + (parseInt(e(t).css("borderLeftWidth"), 10) || 0) +
              (parseInt(e(t).css("paddingLeft"), 10) || 0) - this.margins.left,
              n.top + (parseInt(e(t).css("borderTopWidth"), 10) || 0) +
              (parseInt(e(t).css("paddingTop"), 10) || 0) - this.margins.top,
              n.left +
      ...
      _generatePosition: function (t) {
        var n,
          ...
          u = this.cssPosition !== "absolute" ||
            ...
            : this.offsetParent,
          a = /(html|body)/i.test(u[0].tagName);
        return this.cssPosition === "relative" &&
          (this.scrollParent[0] === document ||
          ...
          (this.containment &&
            ...
            (n = this.originalPageY +
              ...
              s = this.containment
                ...
                : r)),
          {
            top: o - this.offset.click.top - this.offset.relative.top -
              this.offset.parent.top + (this.cssPosition === "fixed"
                ? -this.scrollParent.scrollTop()
                : a
                ? 0
                : u.scrollTop()),
            left: s - this.offset.click.left - this.offset.relative.left -
              this.offset.parent.left + (this.cssPosition === "fixed"
                ? -this.scrollParent.scrollLeft()
                : a
                ? 0
    ...
    "ui.spinner",
    {
      ...
      _draw: function () {
        var e = this.uiSpinner = this.element.addClass("ui-spinner-input").attr(
          "autocomplete",
          "off",
        ).wrap(this._uiSpinnerHtml()).parent().append(this._buttonHtml());
        this.element.attr("role", "spinbutton"),
          this.buttons = e.find(".ui-spinner-button").attr("tabIndex", -1)
            .button().removeClass("ui-corner-all"),
          this.buttons.height() > Math.ceil(e.height() * .5) &&
          e.height() > 0 && e.height(e.height()),
      ...
      _adjustValue: function (e) {
        ...
        return t = r.min !== null ? r.min : 0,
          ...
          r.max !== null && e > r.max ? r.max : r.min !== null && e < r.min
            ? r.min
            : e;
      },
      _stop: function (e) {
      ...
      _setOption: function (e, t) {
        ...
        (e === "max" || e === "min" || e === "step") && typeof t == "string" &&
        (t = this._parse(t)),
          e === "icons" &&
          (this.buttons.first().find(".ui-icon").removeClass(
            this.options.icons.up,
          ).addClass(t.up),
            this.buttons.last().find(".ui-icon").removeClass(
    ...
    "ui.tabs",
    {
      ...
      _create: function () {
        ...
        this.running = !1,
          ...
          ).toggleClass("ui-tabs-collapsible", n.collapsible).delegate(
            ".ui-tabs-nav > li",
            "mousedown" + this.eventNamespace,
            function (t) {
      ...
      _initialActive: function () {
        ...
        return t !== !1 &&
          (t = this.tabs.index(this.tabs.eq(t)), t === -1 && (t = n ? !1 : 0)),
      ...
      _eventHandler: function (t) {
        ...
        t.preventDefault();
        if (
          s.hasClass("ui-state-disabled") || s.hasClass("ui-tabs-loading") ||
          this.running || o && !n.collapsible ||
        ...
        this.running = !0,
          s.length && this.options.hide
            ? this._hide(s, this.options.hide, function () {
              n.oldTab.closest("li").removeClass(
          ...
          i.length && s.length
            ...
            : i.length && this.tabs.filter(function () {
              return e(this).attr("tabIndex") === 0;
            }).attr("tabIndex", -1),
          ...
          this.tabs.add(this.panels).each(function () {
            e.data(this, "ui-tabs-destroy")
              ...
              : e(this).removeClass(
                ...
                "aria-busy",
              ).removeAttr("aria-selected").removeAttr("aria-labelledby")
                .removeAttr("aria-hidden").removeAttr("aria-expanded")
                .removeAttr("role");
          }),
      ...
      load: function (t, n) {
        ...
        this.xhr = e.ajax(this._ajaxSettings(o, n, a)),
          this.xhr && this.xhr.statusText !== "canceled" &&
...
(function (e) {
  ...
  e.widget("ui.tooltip", {
    ...
    _tooltip: function (n) {
      var r = "ui-tooltip-" + t++,
        i = e("<div>").attr({ id: r, role: "tooltip" }).addClass(
